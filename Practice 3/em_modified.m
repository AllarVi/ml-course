...
K=4; % this is number of clusters, hyperparameter
[rows,~] =size(DD);
% Now let us fit the gaussians
% intialize
Pi=ones(K)*1/4; % initial responsibilities are set to be equal in the beginning
...
c_estim(4).matrix =[1,3;4,2]*[3,0 ;0, 2]*[1,3;4,2]';
